...
# ---------- PAGE CONFIG ----------
st.set_page_config(page_title="Meezan Bank AI Parser", layout="wide")
...
# ---------- LOGO PATHS ----------
logo_path = "meezan-logo.png"       # your Meezan Bank logo
...
# ---------- LAYOUT ----------
    ...
    with col2:
        ...
        st.markdown("<h2>Meezan Bank</h2>", unsafe_allow_html=True)
        ...
        if login:
            if email == "admin@meezan.com" and password == "12345":
